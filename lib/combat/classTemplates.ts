...
export const CLASS_TEMPLATES: ClassAlias[] = [
  ...
  { templateId: "devotion-paladin", className: "paladin", subclassName: "Oath of Devotion",
    aliases: ["devotion paladin", "oath of devotion paladin", "oath of devotion"] },
  { templateId: "ancients-paladin", className: "paladin", subclassName: "Oath of the Ancients",
    aliases: ["ancients paladin", "oath of the ancients paladin", "oath of the ancients", "ancient paladin"] },
  { templateId: "vengeance-paladin", className: "paladin", subclassName: "Oath of Vengeance",
    aliases: ["paladin", "vengeance paladin", "oath of vengeance paladin", "oath of vengeance"] },
  { templateId: "conquest-paladin", className: "paladin", subclassName: "Oath of Conquest",
    aliases: ["conquest paladin", "oath of conquest paladin", "oath of conquest"] },
  { templateId: "redemption-paladin", className: "paladin", subclassName: "Oath of Redemption",
    aliases: ["redemption paladin", "oath of redemption paladin", "oath of redemption"] },
  { templateId: "glory-paladin", className: "paladin", subclassName: "Oath of Glory",
    aliases: ["glory paladin", "oath of glory paladin", "oath of glory"] },
  { templateId: "watchers-paladin", className: "paladin", subclassName: "Oath of the Watchers",
    aliases: ["watchers paladin", "oath of the watchers paladin", "oath of the watchers"] },
  { templateId: "crown-paladin", className: "paladin", subclassName: "Oath of the Crown",
    aliases: ["crown paladin", "oath of the crown paladin", "oath of the crown"] },
  { templateId: "oathbreaker-paladin", className: "paladin", subclassName: "Oathbreaker",
    aliases: ["oathbreaker paladin", "oathbreaker"] },
  ...
  { templateId: "archfey-warlock-chain", className: "warlock", subclassName: "The Archfey (Pact of the Chain)",
    aliases: ["archfey chain warlock", "archfey warlock (pact of the chain)", "archfey pact of the chain warlock"] },
  { templateId: "archfey-warlock-talisman", className: "warlock", subclassName: "The Archfey (Pact of the Talisman)",
    aliases: ["archfey talisman warlock", "archfey warlock (pact of the talisman)", "archfey pact of the talisman warlock"] },
  { templateId: "celestial-warlock-chain", className: "warlock", subclassName: "The Celestial (Pact of the Chain)",
    aliases: ["celestial chain warlock", "celestial warlock (pact of the chain)", "celestial pact of the chain warlock"] },
  { templateId: "celestial-warlock-talisman", className: "warlock", subclassName: "The Celestial (Pact of the Talisman)",
    aliases: ["celestial talisman warlock", "celestial warlock (pact of the talisman)", "celestial pact of the talisman warlock"] },
  { templateId: "fathomless-warlock-chain", className: "warlock", subclassName: "The Fathomless (Pact of the Chain)",
    aliases: ["fathomless chain warlock", "fathomless warlock (pact of the chain)", "fathomless pact of the chain warlock"] },
  { templateId: "fathomless-warlock-talisman", className: "warlock", subclassName: "The Fathomless (Pact of the Talisman)",
    aliases: ["fathomless talisman warlock", "fathomless warlock (pact of the talisman)", "fathomless pact of the talisman warlock"] },
  { templateId: "fiend-warlock-chain", className: "warlock", subclassName: "The Fiend (Pact of the Chain)",
    aliases: ["fiend chain warlock", "fiend warlock (pact of the chain)", "fiend pact of the chain warlock"] },
  { templateId: "fiend-warlock-talisman", className: "warlock", subclassName: "The Fiend (Pact of the Talisman)",
    aliases: ["fiend talisman warlock", "fiend warlock (pact of the talisman)", "fiend pact of the talisman warlock"] },
  { templateId: "great-old-one-warlock-chain", className: "warlock", subclassName: "The Great Old One (Pact of the Chain)",
    aliases: ["great old one chain warlock", "great old one warlock (pact of the chain)", "great old one pact of the chain warlock"] },
  { templateId: "great-old-one-warlock-talisman", className: "warlock", subclassName: "The Great Old One (Pact of the Talisman)",
    aliases: ["great old one talisman warlock", "great old one warlock (pact of the talisman)", "great old one pact of the talisman warlock"] },
  { templateId: "hexblade-warlock-chain", className: "warlock", subclassName: "The Hexblade (Pact of the Chain)",
    aliases: ["hexblade chain warlock", "hexblade warlock (pact of the chain)", "hexblade pact of the chain warlock"] },
  { templateId: "hexblade-warlock-talisman", className: "warlock", subclassName: "The Hexblade (Pact of the Talisman)",
    aliases: ["hexblade talisman warlock", "hexblade warlock (pact of the talisman)", "hexblade pact of the talisman warlock"] },
  { templateId: "undead-warlock-chain", className: "warlock", subclassName: "The Undead (Pact of the Chain)",
    aliases: ["undead chain warlock", "undead warlock (pact of the chain)", "undead pact of the chain warlock"] },
  { templateId: "undead-warlock-talisman", className: "warlock", subclassName: "The Undead (Pact of the Talisman)",
    aliases: ["undead talisman warlock", "undead warlock (pact of the talisman)", "undead pact of the talisman warlock"] },
  { templateId: "undying-warlock-chain", className: "warlock", subclassName: "The Undying (Pact of the Chain)",
    aliases: ["undying chain warlock", "undying warlock (pact of the chain)", "undying pact of the chain warlock"] },
  { templateId: "undying-warlock-talisman", className: "warlock", subclassName: "The Undying (Pact of the Talisman)",
    aliases: ["undying talisman warlock", "undying warlock (pact of the talisman)", "undying pact of the talisman warlock"] },
  { templateId: "dao-genie-warlock-chain", className: "warlock", subclassName: "The Genie (Dao) (Pact of the Chain)",
    aliases: ["dao genie chain warlock", "dao genie warlock (pact of the chain)", "dao genie pact of the chain warlock"] },
  { templateId: "dao-genie-warlock-talisman", className: "warlock", subclassName: "The Genie (Dao) (Pact of the Talisman)",
    aliases: ["dao genie talisman warlock", "dao genie warlock (pact of the talisman)", "dao genie pact of the talisman warlock"] },
  { templateId: "djinni-genie-warlock-chain", className: "warlock", subclassName: "The Genie (Djinni) (Pact of the Chain)",
    aliases: ["djinni genie chain warlock", "djinni genie warlock (pact of the chain)", "djinni genie pact of the chain warlock"] },
  { templateId: "djinni-genie-warlock-talisman", className: "warlock", subclassName: "The Genie (Djinni) (Pact of the Talisman)",
    aliases: ["djinni genie talisman warlock", "djinni genie warlock (pact of the talisman)", "djinni genie pact of the talisman warlock"] },
  { templateId: "efreeti-genie-warlock-chain", className: "warlock", subclassName: "The Genie (Efreeti) (Pact of the Chain)",
    aliases: ["efreeti genie chain warlock", "efreeti genie warlock (pact of the chain)", "efreeti genie pact of the chain warlock"] },
  { templateId: "efreeti-genie-warlock-talisman", className: "warlock", subclassName: "The Genie (Efreeti) (Pact of the Talisman)",
    aliases: ["efreeti genie talisman warlock", "efreeti genie warlock (pact of the talisman)", "efreeti genie pact of the talisman warlock"] },
  { templateId: "marid-genie-warlock-chain", className: "warlock", subclassName: "The Genie (Marid) (Pact of the Chain)",
    aliases: ["marid genie chain warlock", "marid genie warlock (pact of the chain)", "marid genie pact of the chain warlock"] },
  { templateId: "marid-genie-warlock-talisman", className: "warlock", subclassName: "The Genie (Marid) (Pact of the Talisman)",
    aliases: ["marid genie talisman warlock", "marid genie warlock (pact of the talisman)", "marid genie pact of the talisman warlock"] },
  { templateId: "lore-bard", className: "bard", subclassName: "College of Lore",
    aliases: ["bard", "lore bard", "college of lore bard", "bard of lore", "college of lore"] },
  { templateId: "valor-bard", className: "bard", subclassName: "College of Valor",
    aliases: ["valor bard", "college of valor bard", "bard of valor", "college of valor"] },
  { templateId: "glamour-bard", className: "bard", subclassName: "College of Glamour",
    aliases: ["glamour bard", "college of glamour bard", "bard of glamour", "college of glamour"] },
  { templateId: "swords-bard", className: "bard", subclassName: "College of Swords",
    aliases: ["swords bard", "college of swords bard", "bard of swords", "college of swords"] },
  { templateId: "whispers-bard", className: "bard", subclassName: "College of Whispers",
    aliases: ["whispers bard", "college of whispers bard", "bard of whispers", "college of whispers"] },
  { templateId: "creation-bard", className: "bard", subclassName: "College of Creation",
    aliases: ["creation bard", "college of creation bard", "bard of creation", "college of creation"] },
  { templateId: "eloquence-bard", className: "bard", subclassName: "College of Eloquence",
    aliases: ["eloquence bard", "college of eloquence bard", "bard of eloquence", "college of eloquence"] },
  { templateId: "spirits-bard", className: "bard", subclassName: "College of Spirits",
    aliases: ["spirits bard", "college of spirits bard", "bard of spirits", "college of spirits"] },
